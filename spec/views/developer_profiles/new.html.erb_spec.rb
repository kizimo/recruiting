...
describe "developer_profiles/new" do
  before(:each) do
    assign(:developer_profile, stub_model(DeveloperProfile,
      :user_id => 1,
      :employment => "MyString",
      :experience => "MyString",
  ...
  it "renders new developer_profile form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", developer_profiles_path, "post" do
