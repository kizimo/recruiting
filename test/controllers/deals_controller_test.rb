...
class DealsControllerTest < ActionController::TestCase
  ...
  test "should update deal" do
    patch :update, id: @deal, deal: { amount_to_raise: @deal.amount_to_raise, description: @deal.description, followers_count: @deal.followers_count, state: @deal.state, user_id: @deal.user_id }
    assert_redirected_to deal_path(assigns(:deal))
  end
